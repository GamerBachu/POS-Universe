...
const AdjustmentButtons = () => {
    ...
    const onAddDiscount = () => {
        setIsOpen(true);
        setTitle(resource.pos_t1.title_add_discount);
        setCategory("DISCOUNT");
    };
    const onAddServiceCharge = () => {
        setIsOpen(true);
        setTitle(resource.pos_t1.title_add_service_charge);
        setCategory("CHARGE");
    };
    const onClose = () => {
        setIsOpen(false);
        ...
        <>
            <div className="flex gap-2 w-full">
                ...
                >
                    ...
                    <span>{resource.pos_t1.btn_add_discount}</span>
                </button>
                ...
                >
                    ...
                    <span>{resource.pos_t1.btn_service_charge}</span>
                </button>
            </div>
            <AdjustmentModal
                isOpen={isOpen}
