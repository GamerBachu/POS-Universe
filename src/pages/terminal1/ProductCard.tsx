...
const ProductCard = ({
    ...
    return (
        <button
            className="group flex flex-col bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-teal-500 hover:shadow-lg transition-all text-center active:scale-95"
            onClick={onClick}
        >
            ...
            <span className="text-sm font-bold text-teal-600 dark:text-teal-400">{id}</span>
